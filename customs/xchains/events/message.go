...
type XChainsMessageEventParser struct {
	Id      string
	Indexer *indexer.Indexer
}

func (p *XChainsMessageEventParser) Identifier() string {
	return p.Id
}

func (p *XChainsMessageEventParser) ParseBlockEvent(event abci.Event, conf config.IndexConfig) (*any, error) {
...
func (p *XChainsMessageEventParser) IndexBlockEvent(parsedData *any, db *gorm.DB, block models.Block, blockEvent models.BlockEvent, blockEventAttrs []models.BlockEventAttribute, cfg config.IndexConfig) error {
	return nil
}
